...
public class ChartViewBase: UIView, ChartDataProvider, ChartAnimatorDelegate
{
    ...
    internal var _defaultValueFormatter: NSNumberFormatter = ChartUtils_Pie.defaultValueFormatter()
    ...
    internal func calculateFormatter(min min: Double, max: Double)
    {
        ...
        let digits = ChartUtils_Pie.decimals(reference)

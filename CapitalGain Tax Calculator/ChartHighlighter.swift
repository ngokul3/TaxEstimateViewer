...
internal class ChartHighlighter
{
    ...
    internal func getDataSetIndex(xIndex xIndex: Int, x: Double, y: Double) -> Int
    {
        ...
        let leftdist = ChartUtils_Pie.getMinimumDistance(valsAtIndex, val: y, axis: ChartYAxis.AxisDependency.Left)
        let rightdist = ChartUtils_Pie.getMinimumDistance(valsAtIndex, val: y, axis: ChartYAxis.AxisDependency.Right)
        
        let axis = leftdist < rightdist ? ChartYAxis.AxisDependency.Left : ChartYAxis.AxisDependency.Right
        
        let dataSetIndex = ChartUtils_Pie.closestDataSetIndex(valsAtIndex, value: y, axis: axis)

...
public class BarLineChartViewBase: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, UIGestureRecognizerDelegate
{
    ...
    public override func drawRect(rect: CGRect)
    {
        ...
        {
           // _xAxisRenderer!.calcXBounds(chart: self, xAxisModulus: _xAxis.axisLabelModulus) //Convert
        }
        if (renderer !== nil)
        {
            //renderer!.calcXBounds(chart: self, xAxisModulus: _xAxis.axisLabelModulus) //Convert
        }

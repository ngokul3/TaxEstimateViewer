...
public class ChartYAxisRendererRadarChart: ChartYAxisRenderer
{
    ...
    internal override func computeAxisValues(min yMin: Double, max yMax: Double)
    {
        ...
        else
        {
            ...
            var last = ChartUtils_Pie.nextUp(floor(Double(yMax) / interval) * interval);
    ...
    public override func renderAxisLabels(#context: CGContext)
    {
        ...
        for (var j = 0; j < labelCount; j++)
        {
            ...
            var p = ChartUtils_Pie.getPosition(center: center, dist: r, angle: _chart.rotationAngle);
    ...
    public override func renderLimitLines(#context: CGContext)
    {
        ...
        for (var i = 0; i < limitLines.count; i++)
        {
            ...
            {
                var p = ChartUtils_Pie.getPosition(center: center, dist: r, angle: sliceangle * CGFloat(j) + _chart.rotationAngle);
